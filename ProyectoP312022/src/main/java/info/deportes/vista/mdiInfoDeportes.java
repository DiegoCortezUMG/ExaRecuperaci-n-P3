...
public class mdiInfoDeportes extends javax.swing.JFrame {
    ...
    public mdiInfoDeportes() {
        ...
        this.setExtendedState(mdiInfoDeportes.MAXIMIZED_BOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(mdiInfoDeportes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new mdiInfoDeportes().setVisible(true);
            }
        });
    }
